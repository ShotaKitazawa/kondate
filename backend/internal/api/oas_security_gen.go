...
var operationRolesBearerAuth = map[string][]string{
	ArchiveBlockByIdOperation:     []string{},
	CreateBlockOperation:          []string{},
	CreateDayOperation:            []string{},
	CreateShoppingItemOperation:   []string{},
	DeleteBlockOperation:          []string{},
	DeleteDayOperation:            []string{},
	DeleteShoppingItemOperation:   []string{},
	GetBlockOperation:             []string{},
	GetCurrentBlockOperation:      []string{},
	ListBlocksOperation:           []string{},
	ReorderShoppingItemsOperation: []string{},
	UnarchiveBlockOperation:       []string{},
	UpdateDayOperation:            []string{},
	UpdateShoppingItemOperation:   []string{},
}
